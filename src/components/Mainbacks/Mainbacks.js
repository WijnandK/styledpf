...
import cert1 from "../../static/images/cert1.jpg";
 import rol2 from "../../static/images/rol2.png";
  ...
  render() {
    ...
    switch (this.props.type) {
        ...
        tpx = (
          <div className={`tpx-one  fadein  `}>
            ...
            <Swiperflip
              imageone={nstore}
              imagetwo={javajs}
              imagethree={nextstore}
              imagefour={nodejsblack}
              imagefive={nextjs2}
              imagesix={jsvg}
            />
            <div className="tpx-one-btn">
              <a href="https://nextjsshop.now.sh/login" className="shopbtn">
                VISIT
              </a>
            </div>
          </div>
        ...
        tpx = (
          <div className={`tpx-two fadeout`}>
            ...
            <div className="tpx-two-btn">
              <a
                href="https://vibrant-montalcini-6fcf23.netlify.app/"
                className="shopbtn"
              >
                VISIT
              </a>
        ...
        tpx = (
          <div className={`tpx-three fadein`}>
            ...
            <div className="tpx-three-btn">
              <a href="https://maxplacesapp.web.app/" className="shopbtn">
                VISIT
              </a>
            </div>
          </div>
      ...
      case 3:
        tpx = (
          <div className={`tpx-four fadeout`}>
            ...
            <div className="tpx-four-btn">
              <a
                href="https://powerful-ridge-27803.herokuapp.com/"
                className="shopbtn"
              >
                VISIT
              </a>
        ...
        tpx = (
          <div className={`tpx-one  fadein  `}>
            <h1 className="tpx-one-title">Ecommerce</h1>
            <Swiperflip
              imageone={zstore1}
              imagetwo={jsvg}
              imagethree={zstore2}
              imagefour={cert1  }
              imagefive={nodejsblack}
              imagesix={rol2}
            />
            <div className="tpx-one-btn">
              <a href="https://quirky-bhabha-15bb06.netlify.app/#/" className="shopbtn">
                VISIT
              </a>
            </div>
          </div>
